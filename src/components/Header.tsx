			...
			<nav>
				<Fade cascade direction="up" duration={100}>
					...
					<div className="menu">
						...
						<span>{t.getTranslation('header_languages')}</span>
						<div className="submenu">
							<Fade cascade direction="up" duration={100}>
								<button
									className={`language ${t.getLanguage() === languages.EN ? 'active' : ''}`}
									onClick={() => {
										t.changeLanguage(languages.EN);
										setIsToggled(false);
									}}
								>
								...
								<button
									className={`language ${t.getLanguage() === languages.FR ? 'active' : ''}`}
									onClick={() => {
										t.changeLanguage(languages.FR);
										setIsToggled(false);
									}}
								>
